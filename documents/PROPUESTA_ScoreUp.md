...
- La interfaz está desarrollada con Tailwind CSS (vía CDN), lo que permite un diseño responsivo sin necesidad de herramientas de compilación adicionales.
- El sistema permite la carga de evidencia fotográfica para incidentes disciplinarios (formatos png, jpg, gif, webp), almacenada localmente en `static/uploads/`.
